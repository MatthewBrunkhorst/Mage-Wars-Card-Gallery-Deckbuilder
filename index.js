...
const cards = [                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
    ...
    ["Shaggoth-Zora",                  Creature, ["Undead", "Zombie", "NONE", "NONE"],      8,  -1, Full, 0, 0, "Zone", [3, [3, Dark, SCHOOL, SCHOOL, SCHOOL, SCHOOL], BlankLevelPart, BlankLevelPart, BlankLevelPart],                            [MeleeAttack, BloodthirstyPlusX, Lumbering, PsychicImmune, Nonliving, Legendary, Obliterate, Growth, Condition, Zombie, KEYWORD, KEYWORD, KEYWORD, KEYWORD, KEYWORD],          [["Mangling Claws",    Quick, Melee,  0, 0, Typeless, 4, [-1, "NONE"],   [-1, "NONE"],   [-1, "NONE"], [-1, "NONE"], "NONE"],                       BlankAttack,                                                                                                                                                              BlankAttack,                                                                                                                                                                                      BlankAttack], BlankDefenses,                       SLOT, 0, 6,  "When Shaggoth-Zora is activated, it may Obliterate 1 friendly zombie creature in its zone to place a Growth marker on itself. It can have a maximum of 6 Growth markers."],                                                                                                          
...
function addCardToGrid(card) {
    ...
    typeDiv.textContent = typeText(card);
    ...
    if (type(card) === Creature) {
        ...
        armorDiv.textContent = armorText(card);
        middleDiv.appendChild(armorDiv);
        var healthDiv = document.createElement('div');
        healthDiv.className = "health";
        healthDiv.textContent = lifeText(card);
        middleDiv.appendChild(healthDiv);
    }
    ...
    for (let i = 0; i < 4; i++) {
        ...
        if (currentAttack[2] !== MELEERANGEDZONETRAMPLEANY) {
            ...
            if (currentAttack[2] === Melee || currentAttack[2] === Ranged || currentAttack[2] === Zone || currentAttack[2] === Trample || currentAttack[2] === DamageBarrier) {
                if (currentAttack[2] === Melee) {
                    ...
                    attackDiv.appendChild(attackTypeImg);
                } else if (currentAttack[2] === Ranged || currentAttack[2] === Zone) {
                    if (type(card) === Creature || type(card) === Equipment) {
    ...
    textDiv.textContent = otherText(card);
