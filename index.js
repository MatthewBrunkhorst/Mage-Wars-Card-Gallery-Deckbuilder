...
const Zone = 3
const Trample = 4
const NonAttackMelee = 5
const NonAttackRanged = 6
const NonAttackZone = 7
const Any = 8
...
const DamageBarrier = 47
Keywords[DamageBarrier] = "Damage Barrier"
const Daze = 48
Keywords[Daze] = "Daze"
const Defense = 49
...
async function main() {
    searchButton.addEventListener('click', function(){updateTempTest()});
